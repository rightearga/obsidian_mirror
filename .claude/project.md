...
| 关系图谱 | ✅ 稳定 | Sigma.js 2 WebGL 渲染 + WASM ForceAtlas2 布局（v1.9.7）；2k 节点布局 <1s；路径查找 BFS（v1.9.2） |
| 知识地图 | ✅ 稳定 | Canvas 渲染 + LOD，标签相似度聚类，K-means，WASM ForceAtlas2/F-R 布局（v1.9.5, v1.9.6, v1.9.7） |
